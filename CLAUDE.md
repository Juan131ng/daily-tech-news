...
每日科技资讯 Top 10 — 自动抓取全球科技新闻，由 DeepSeek AI 进行筛选、排序和中文摘要。

## 工作流程

```
RSS 源 / Hacker News API → Python 抓取去重 → DeepSeek API 排序摘要 → data.json → GitHub Pages 展示
```
...
1. 将项目推送到 GitHub 仓库
2. 在 Settings → Secrets and variables → Actions 中添加 `DEEPSEEK_API_KEY`
